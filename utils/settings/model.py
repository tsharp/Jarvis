"""
utils/settings/model.py — Single Source of Truth for Model Configuration
...
Usage:
    from utils.settings.model import ALLOWED_MODEL_KEYS, MODEL_DEFAULTS, get_effective_model_settings
"""
