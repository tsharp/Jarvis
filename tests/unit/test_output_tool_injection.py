...
class TestOutputToolInjection(unittest.TestCase):
    ...
    def test_skill_catalog_context_prompt_adds_skill_semantics_rules(self, *_mocks):
        ...
        self.assertIn("Bevorzugte Reihenfolge: `Runtime-Skills`, dann `Einordnung`, danach optional `Nächster Schritt`.", prompt)
        ...
        self.assertIn("vermeide starre Satzanfangsformeln", prompt)
        self.assertNotIn("Die Antwort MUSS mit dem Literal `Runtime-Skills:` beginnen.", prompt)
        self.assertIn("EMPFOHLENE ANTWORTSTRUKTUR", prompt)
    ...
    def test_skill_catalog_context_prompt_requires_split_for_inventory_plus_followup(self, *_mocks):
        ...
        self.assertIn("Bevorzugte Reihenfolge: `Runtime-Skills`, dann `Einordnung`, danach optional `Wunsch-Skills`.", prompt)
    ...
    def test_container_inventory_prompt_adds_runtime_inventory_contract(self, *_mocks):
        ...
        self.assertIn("Bevorzugte Reihenfolge: `Laufende Container`, dann `Gestoppte Container`, dann `Einordnung`.", prompt)
        self.assertIn("vermeide starre Satzanfangsformeln", prompt)
        self.assertNotIn("Die Antwort MUSS mit dem Literal `Laufende Container:` beginnen.", prompt)
    ...
    def test_container_blueprint_prompt_adds_catalog_contract(self, *_mocks):
        ...
        self.assertIn("Bevorzugte Reihenfolge: `Verfuegbare Blueprints`, dann `Einordnung`.", prompt)
        ...
        self.assertNotIn("Die Antwort MUSS mit dem Literal `Verfuegbare Blueprints:` beginnen.", prompt)
    ...
    def test_container_binding_prompt_adds_binding_contract(self, *_mocks):
        ...
        self.assertIn("Bevorzugte Reihenfolge: `Aktiver Container`, dann `Binding/Status`, dann `Einordnung`.", prompt)
        ...
        self.assertNotIn("Die Antwort MUSS mit dem Literal `Aktiver Container:` beginnen.", prompt)
