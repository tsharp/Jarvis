...
# Save original for comparison (step is modified in place!)
original_query1 = step1.query
...
assert corrected_step1.query != original_query1, "Query should have been modified"
...
assert corrected_step2.query != original_query2, "Query should have been modified"
...
original_output1 = result1.output
...
assert corrected_result1.output != original_output1, "Output should have been modified"
...
original_output2 = result2.output
...
assert corrected_result2.output != original_output2, "Output should have been modified"
